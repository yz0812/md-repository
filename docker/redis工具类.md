...
<span style='color:red'>CollectionUtils可以用其他代替</span>

```java
package cn.business.framework.redis.service;

import cn.business.framework.common.util.collection.CollectionUtils;
import cn.business.framework.redis.core.CacheKey;
...
public class BaseRedis {
    ...
    public void mSet(Object... keysValues) {
        this.valueOps.multiSet(CollectionUtils.toMap(keysValues));
    }
...
```java
package cn.business.framework.redis.core;
